...
<head>
    <meta charset="utf-8">
    <title>Carolyn's Most-Watched Movies</title>
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">Carolyn's Most-Watched Movies</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">  <!--  # NOQA  -->
    <span data-toggle="tooltip" title="{movie_storyline}">
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        content += movie_tile_content.format(
            ...
            #  Added storyline and rating system
            movie_storyline=movie.storyline,
            movie_rating=star_ratings(movie.movie_rating)
        )
        movie_rating = movie.movie_rating

    return content

# New function to add star images to movie landing page
